...
class Estimator():
    ...
    def _build_model(self):
        ...
        # second fully connected layer- input 512, num_filters 4, linear
        ...
        #ww1 = tf.reshape(w1, [1, 8, 8, 32]) # 32, 8,8,4
...
experiment_dir = os.path.abspath("./experiments-frames5-99/{}".format(env.spec.id))
